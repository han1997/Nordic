...
assert any(s.attrib["name"].endswith("WebDavPlaybackContextTest") for s in suites)
...
for variant in ["debug", "release"]:
    ...
    assert item["versionName"] == "0.1.6" and item["versionCode"] == 6
    assert meta["applicationId"] == "fun.han1997.nordic"
    if variant == "release":
        assert item["outputFile"] == "nordic-0.1.6.apk"
        release_apk = apk
    ...
    assert "name='fun.han1997.nordic' versionCode='6' versionName='0.1.6'" in badging
