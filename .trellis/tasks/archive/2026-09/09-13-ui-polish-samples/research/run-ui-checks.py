...
def main():
    ...
    parser.add_argument("--kind", choices=["screenshots", "interaction", "live"], default="screenshots")
    ...
    try:
        ...
        klass = {"screenshots": "UiCatalogScreenshotTest", "interaction": "UiCatalogInteractionTest", "live": "MainSettingsUiTest"}[args.kind]
        ...
        if args.kind == "interaction":
            ...
            for name in ("player-controls-large.png", "lyrics-controls-large.png"):
                run("pull", remote + "/" + name, output / name)
