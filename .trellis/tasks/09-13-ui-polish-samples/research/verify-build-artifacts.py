...
EVIDENCE = ROOT / "app/build/reports/ui-polish/artifacts"
...
for required in ["EncryptedConfigStoreReactivityTest", "EncryptedPreferencesInstanceTest", "EncryptedConfigStoreTest", "SettingsCenterTest", "NordicDesignContractTest", "SettingsRowLayoutTest", "QueueItemGeometryTest"]:
...
assert not re.search(r"^com\.nordic\.mediahub\.(?:UiCatalogActivity|ui\.UiSample[^ ]*) ->", mapping, re.M), "Debug catalog leaked into release DEX"
